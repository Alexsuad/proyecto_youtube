...
PAYLOAD = ROOT / "profiles/editorial/mas_alla_del_guion/1.2.2/profile_payload.json"
...
def test_preflight_is_read_only_and_never_activates(tmp_path):
    ...
    assert not (tmp_path / "profiles/editorial/mas_alla_del_guion/1.2.2/editorial_profile.json").exists()
