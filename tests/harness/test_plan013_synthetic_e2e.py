...
def test_plan013_integrated_synthetic_e2e_from_human_intake_to_convergent_close(tmp_path, monkeypatch) -> None:
    ...
    resolve_role_execution_contract("YOUTUBE_ADAPTATION_AUDITOR", "final_script_review", {"youtube_adaptation_b5_i2_package": {}, "producer_run_reference": writing.run_id, "active_editorial_profile_reference": active_profile, "refined_thesis": thesis, "claims_ledger": {}, "evidence_report": {}}, {"clean_session": True, "required_context": {"audit_criteria": "criteria", "profile_identity": "profile"}})
