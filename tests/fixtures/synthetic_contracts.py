...
VALID_EDITORIAL_PROFILE: Dict[str, Any] = {
    ...
    "source_lineage": [{"source_id": "B3-FUNCTIONAL-SPEC", "locator": "docs/specifications/B3_editorial_profile_functional_specification.md", "checksum": VALID_CHECKSUM, "role": "FUNCTIONAL_SPECIFICATION"}],
