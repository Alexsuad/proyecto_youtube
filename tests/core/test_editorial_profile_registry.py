...
def test_activation_requires_matching_evidence():
 ...
 a={'decision':'APPROVE','profile_id':p['profile_id'],'profile_version':p['version'],'profile_checksum':c,'functional_owner_role':'TEAM_01','approved_by':'equipo_01_responsable','approved_at':'2026-07-22T20:00:00Z'}
