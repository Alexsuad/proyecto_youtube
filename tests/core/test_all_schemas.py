...
VALID_FIXTURES = {
    ...
    "b5_i2_semantic_sufficiency_audit": {"audit_id":"B5I2-SSA-1","episode_id":"EP-1","analysis_checksums":[{"analysis_id":"A-1","checksum":"a"*64}],"curation_checksum":"a"*64,"refined_thesis_checksum":"a"*64,"early_packaging_checksum":"a"*64,"audited_by":"team_02_ai","audit_method":"AI_SEMANTIC_REVIEW","findings":[{"criterion":criterion,"assessment":"SATISFIED","rationale":"Evaluado.","references":["artifact"]} for criterion in ["ANALYSIS_SPECIFICITY","MATERIAL_ANALYSIS_COVERAGE","RIVAL_INTERPRETATION_AND_LIMITS","INHERITED_RESTRICTION_PROPAGATION","CURATION_COMPLETENESS","CURATION_CONTRAST_AND_PROGRESSION","THESIS_REFINEMENT_SUBSTANCE","EVIDENCE_TRACEABILITY","EARLY_PACKAGING_HONESTY"]],"decision":"PASS","created_at":"2026-07-24T20:00:00Z"},
    "viewer_journey": {
