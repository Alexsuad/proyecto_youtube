...
VALID_FIXTURES = {
    ...
    "episode_brief": {
        ...
        "tesis_provisional": "El miedo al fracaso crece cuando confundimos error con identidad.",
        ...
        "obra_o_fuente_principal": "Obra sintética de prueba",
    ...
    "thesis_artifact": {
        ...
        "supporting_reasoning": "Razonamiento inicial trazable.",
        "main_objection": "La relación podría explicarse por otro factor.",
        "simplification_risk": "Generalizar una lectura narrativa.",
