...
VALID_FIXTURES = {
        ...
        "runs": [
            {
                ...
                "outputs": [{"artifact_kind": "semantic_audit", "artifact_id": "AUD-1", "checksum": "a" * 64}],
    ...
    "b5_i2_semantic_sufficiency_audit": {"audit_id":"B5I2-SSA-1","episode_id":"EP-1","auditor_role":"INDEPENDENT_EDITORIAL_AUDITOR","auditor_run_id":"RUN-AUDIT-1","auditor_skill_id":"skill_qa_editorial","auditor_skill_version":"2.0.0","provider_or_adapter":"local-mock-semantic","model_or_evaluator":"semantic-mock-v1","execution_timestamp":"2026-07-25T08:00:00Z","input_manifest_checksum":"a"*64,"artifact_checksums":[{"artifact_kind":"analysis","artifact_id":"A-1","checksum":"a"*64,"producer_run_id":"RUN-AN-1"},{"artifact_kind":"curation","artifact_id":"C-1","checksum":"a"*64,"producer_run_id":"RUN-CU-1"},{"artifact_kind":"thesis","artifact_id":"T-1","checksum":"a"*64,"producer_run_id":"RUN-TH-1"},{"artifact_kind":"packaging","artifact_id":"P-1","checksum":"a"*64,"producer_run_id":"RUN-PK-1"}],"audit_method":"AI_SEMANTIC_REVIEW","findings":[{"criterion":criterion,"status":"SATISFIED","anchored_findings":[{"artifact_kind":"analysis","artifact_id":"A-1","artifact_field":"statement","evaluated_excerpt":"Lectura.","evidence_refs":["F-1"],"evidence_excerpts":[{"evidence_ref":"F-1","excerpt":"Lectura."}],"editorial_comparison":"Comparación editorial trazable.","why_specific_or_generic":"Justificación editorial concreta.","decision":"SATISFIED"}],"rationale":"Evaluado."} for criterion in ["ANALYSIS_SPECIFICITY","MATERIAL_ANALYSIS_COVERAGE","RIVAL_INTERPRETATION_AND_LIMITS","INHERITED_RESTRICTION_PROPAGATION","CURATION_COMPLETENESS","CURATION_CONTRAST_AND_PROGRESSION","THESIS_REFINEMENT_SUBSTANCE","EVIDENCE_TRACEABILITY","EARLY_PACKAGING_HONESTY"]],"decision":"PASS","created_at":"2026-07-25T08:00:00Z"},
    "viewer_journey": {
