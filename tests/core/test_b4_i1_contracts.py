...
def test_responsibility_registry_schema_and_contracts():
    ...
    assert [r['role_id'] for r in registry['responsibilities']]==['ORCHESTRATION','RESEARCH_AND_CURATION','NARRATIVE_ARCHITECTURE','WRITING','EDITOR','FINAL_EDITORIAL_AUDITOR','SCRIPT_PRODUCT_AUDITOR','CHANNEL_INTELLIGENCE_PRODUCER','CHANNEL_INTELLIGENCE_REVIEWER']
