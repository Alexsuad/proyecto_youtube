...
| IR1-016 | SCRIPT_PRODUCT | Impedir que una representación derivada sustituya automáticamente la fuente original. | PARTIAL | reglas de provenance y contratos canónicos | gate / validación | R1.3 | R1-M4 | IR1-015 | R1_GATE | Validación de provenance y bloqueo operativo. | NO | EXTEND. Regla documental sin gate. |
...
| IR3-001 | SCRIPT_PRODUCT | Conservar vídeo original como fuente y transcripción como derivada. | PARTIAL | contratos canónicos de provenance | contrato / provenance | R1.3 | R1-M4 | IR1-015 | R1_GATE | Lineage de fuente derivada. | NO | EXTEND. |
...
| IRA-001 | SCRIPT_PRODUCT | Mantener SOURCE_GROUNDED_RESEARCH_ADAPTER opcional, agnóstico y no autoritativo. | PARTIAL | contrato de adaptador opcional | contrato / interfaz | R1.6 | R1-M11 | IR1 | R1_GATE | Adapter contract opcional. | NO | EXTEND. Evitar que un adaptador externo sea ruta obligatoria. |
...
| IRA-003 | SCRIPT_PRODUCT | Mantener SCRIPT_PRODUCT como owner de suficiencia editorial. | ALREADY_IMPLEMENTED | `config/responsibility_registry.json`; P-08 | registry / policy | R1.6 | R1-M10 | Ninguna | NONE | Sin brecha de autoridad declarativa. | NO | REUSE. Conservar. |
| IRA-004 | SCRIPT_PRODUCT | Separar aprobación funcional, activación técnica y autorización de uso productivo. | PARTIAL | `plans/001_CONTROL_OPERATIVO.md`; schemas de approvals; P-08 | registry / workflow | R1.6 | R1-M11 | IR1-IR7 | R1_GATE | Estados separados en contratos y gates. | NO | EXTEND. |
