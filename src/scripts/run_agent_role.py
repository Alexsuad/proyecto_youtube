...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--timeout", type=int, default=30); parser.add_argument("--max-retries", type=int, default=0); parser.add_argument("--temperature", type=float); parser.add_argument("--max-tokens", type=int); parser.add_argument("--budget-limit", type=float); parser.add_argument("--reasoning-effort"); parser.add_argument("--approve-paid-cost", action="store_true")
