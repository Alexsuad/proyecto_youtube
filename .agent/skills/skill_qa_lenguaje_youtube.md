# Skill — QA Lenguaje YouTube (Modo Ultra Seguro)
Objetivo: Auditoría automática buscando lenguaje que afecte la distribución algorítmica y la monetización en YouTube.

> **Rol ejecutor actual:** Script de validación automatizada (`src/scripts/qa_lenguaje_youtube.py`).
...
Dependencia: `config/qa_youtube_lenguaje.yml`

---

## Pasos

1) Cargar el diccionario (listas roja y amarilla) y zonas críticas desde `config/qa_youtube_lenguaje.yml`.
...
## Salida
- Reporte detallado en: `output/qa_youtube_lenguaje/<ep_folder_name>__qa_youtube.md`
